...
import DepartmentPage from "../pages/user/DepartmentPage.jsx";
    ...
    <>
      <style>{`
                *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                .notif-badge { position: absolute; top: 7px; right: 7px; width: 7px; height: 7px; background: #f44336; border-radius: 50%; border: 1.5px solid #fff; }
        ...
        <aside className={`admin-sidebar ${sidebarOpen ? "is-open" : ""}`}>
          <div className="sidebar-brand">
            ...
            <div style={{ flex: 1 }}>
              ...
              <div className="brand-tagline">Chào mừng bạn</div>
            </div>
